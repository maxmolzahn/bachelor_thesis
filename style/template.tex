\documentclass[listof=totoc,index=totoc,bibliography=totoc,$if(fontsize)$$fontsize$,$endif$$if(lang)$$lang$,$endif$$if(papersize)$$papersize$,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
$if(fontfamily)$
...
% Redefine caption labels to German
...
% CHANGED TO DEFAULT LATEX TEMPLATE FROM PANDOC GIT. OTHERWISE MISSING LIST ENVIRONMENT
$if(csl-refs)$
